...
MAIN.verno=' Kelp Processing v.1';
MAIN.figwidth = .94;
MAIN.figheight = 0.74;
...
MAIN.control.hmen3a=uimenu(MAIN.control.hmen3,'lab','Save DATA','sep','on','call','savedata;disp(''Data have been saved.'')');
MAIN.control.hmen3b=uimenu(MAIN.control.hmen3,'lab','SAVE DATA and Select to Next Image','call','savedatanext;disp(''Data have been saved.'')');
MAIN.control.hmen3d=uimenu(MAIN.control.hmen3,'lab','SAVE DATA and Load Next Image','call','savedataload;disp(''Data has been saved.'')');
...
PARAMS.hizoom=uicontrol(MAIN.hf1,'style','edit','un','n','pos',[.915 .678 .085 .032], ...
    'str',[],'foreg',[0 0 1],'backg',[1 1 1]);
MAIN.control.hizoomx=uicontrol(MAIN.hf1,'style','text','un','n','pos',[.870 .678 .045 .032], ...
    'str','Zoom','foreg',[0 0 0],'backg',[.8 1 1]);
...
MAIN.ha2 = axes('un','norm','pos',...
    [(MAIN.xmen-150)/MAIN.xmen (MAIN.ymen-250/MAIN.aspratio)/MAIN.ymen 140/MAIN.xmen (240/MAIN.aspratio)/MAIN.ymen]);
